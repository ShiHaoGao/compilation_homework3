...
if.else:                                          ; preds = %entry
  ...
  %6 = load i32 (i32, i32)* (i32, i32, i32 (i32, i32)*, i32 (i32, i32)*)*, i32 (i32, i32)* (i32, i32, i32 (i32, i32)*, i32 (i32, i32)*)** %goo_ptr, align 8, !dbg !86
  %7 = load i32, i32* %op1.addr, align 4, !dbg !87
  %8 = load i32, i32* %op2.addr, align 4, !dbg !88
  %9 = load i32 (i32, i32)*, i32 (i32, i32)** %s_fptr, align 8, !dbg !89
  %10 = load i32 (i32, i32)*, i32 (i32, i32)** %a_fptr, align 8, !dbg !90
  %call2 = call i32 (i32, i32)* %6(i32 %7, i32 %8, i32 (i32, i32)* %9, i32 (i32, i32)* %10), !dbg !86
  store i32 (i32, i32)* %call2, i32 (i32, i32)** %t_fptr, align 8, !dbg !91
  br label %if.end

if.end:                                           ; preds = %if.else, %if.then
  %11 = load i32 (i32, i32)*, i32 (i32, i32)** %t_fptr, align 8, !dbg !92
  %12 = load i32, i32* %op1.addr, align 4, !dbg !93
  %13 = load i32, i32* %op2.addr, align 4, !dbg !94
  %call3 = call i32 %11(i32 %12, i32 %13), !dbg !92
  ret i32 0, !dbg !95
}
...
!1 = !DIFile(filename: "test19.c", directory: "/root/hw3/assign3/tests")
!2 = !{}
...
!83 = !DILocation(line: 25, column: 5, scope: !77)
!84 = !DILocation(line: 27, column: 16, scope: !85)
!85 = distinct !DILexicalBlock(scope: !73, file: !1, line: 26, column: 5)
!86 = !DILocation(line: 28, column: 18, scope: !85)
!87 = !DILocation(line: 28, column: 26, scope: !85)
!88 = !DILocation(line: 28, column: 31, scope: !85)
!89 = !DILocation(line: 28, column: 36, scope: !85)
!90 = !DILocation(line: 28, column: 44, scope: !85)
!91 = !DILocation(line: 28, column: 16, scope: !85)
!92 = !DILocation(line: 30, column: 5, scope: !53)
!93 = !DILocation(line: 30, column: 12, scope: !53)
!94 = !DILocation(line: 30, column: 17, scope: !53)
!95 = !DILocation(line: 31, column: 5, scope: !53)
